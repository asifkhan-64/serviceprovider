...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Location</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" value="<?php echo $areaName ?>" placeholder="Location Name" type="text" value="" id="example-text-input"  name="nameArea"  required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="addArea">Update Location</button>
                                </div>
                            </div>
                        </form>
